...
// map함수는 배열안에 있는 각각의 개별 아이템을 찾아와서 어떤 연산작업을 한 이후 다시 해당 아이템을 모아서 새로움 배열로 생성
// const arr = [10, 20, 30];
// const newArr = arr.map((item, index) => (item + 5) * index);
// console.log(newArr);

// CB2 // JS에서 자주만날 콜백함수 3번 예제
// setTimout => 일정 시간 지연 후 실행
// setTimeout(function () {
//   console.log(this);
// }, 300);
...
// 객체 안에 메서드 형식으로 정의한 함수는 외부에 별도 존재하는 함수의 몰백함수로 사용할시, 기존 객체와의 관계성이 제거된다
// const arr3 = [4, 5, 6];
...
// setTimeout(dbj1.func.bind(obj1), 1000);
