...
// 1. 제시어에 끝단어 확인
// 1_1. 컴퓨터에게 최초의 제시어가 무엇인지를 알려줘야 함!
// 1_2. 3_1에서 이벤트의 시작을 알리는 "입력버튼"이 무엇인지 알려워야함!
...
// 1부터 45까지의 6개의 숫자가 랜덤으로 추출되어야 함

// 1. 클릭! 버튼이 무엇인지를 컴퓨터에게 알려줘야 함

// 2. 클릭! 버튼 클릭 시, 숫자 생성되어야 함

// 3. JS > 내장 객체 > 숫자를 랜덤으로 생성해주는 함수
// 3_1. random() => 0~1미만의 실수 & 난수 생성!!
// 0.9999999999999999999999999 * 45 || 44
// (*실수 : 소수점을 가지고 있는 숫자)
